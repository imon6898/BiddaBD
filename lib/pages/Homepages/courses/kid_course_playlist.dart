...
class KidCoursePlayList extends StatefulWidget {
  final KidData? learningData;
  KidCoursePlayList({this.learningData});

  @override
  State<KidCoursePlayList> createState() => _KidCoursePlayListState();
}

class _KidCoursePlayListState extends State<KidCoursePlayList> {
  late YoutubePlayerController _controller;
  @override
  void initState() {
    super.initState();
    final videoID=YoutubePlayer.convertUrlToId(widget.learningData!.kidLink.toString());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: CustomScrollView(
        ...
        slivers: <Widget>[
          CustomSilver(title: widget.learningData!.kidTitle,
            onpress: (){
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      title: CustomText(title: "Video 1 : what is Graphics Design",size: 16,),
