...
class NormalPlaylist extends StatefulWidget {
 final ProDevCourses? learningData;
 NormalPlaylist({this.learningData});

  @override
  State<NormalPlaylist> createState() => _NormalPlaylistState();
}

class _NormalPlaylistState extends State<NormalPlaylist> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: CustomScrollView(
        ...
        slivers: <Widget>[
          CustomSilver(title: widget.learningData!.proTitle,
            onpress: (){
